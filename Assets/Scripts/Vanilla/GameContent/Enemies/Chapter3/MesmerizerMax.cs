...
{
    [EntityBehaviourDefinition(VanillaEnemyNames.mesmerizermax)]
    public class MesmerizerMax : MeleeEnemy
    {
        public MesmerizerMax(string nsp, string name) : base(nsp, name)
        {
        ...
        public static readonly NamespaceID ID = VanillaEnemyID.mesmerizermax;
