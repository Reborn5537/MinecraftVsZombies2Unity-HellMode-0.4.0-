...
{
    [EntityBehaviourDefinition(VanillaBossNames.rebornnightmareaper)]
    public partial class RebornNightmareaper : BossBehaviour
    {
        public RebornNightmareaper(string nsp, string name) : base(nsp, name)
        {
        ...
        public override void PostDeath(Entity entity, DeathInfo deathInfo)
        {
            ...
            Global.Game.Unlock(VanillaUnlockID.dreamend);
