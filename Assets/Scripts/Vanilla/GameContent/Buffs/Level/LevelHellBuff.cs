...
{
    [BuffDefinition(VanillaBuffNames.Level.levelHell)]
    public class LevelHellBuff : BuffDefinition
    {
        public LevelHellBuff(string nsp, string name) : base(nsp, name)
        {
            ...
            AddModifier(new IntModifier(VanillaDifficultyProps.MOTHER_TERROR_EGG_COUNT, NumberOperator.Add, 3));
            AddModifier(new IntModifier(VanillaDifficultyProps.PARASITIZED_TERROR_COUNT, NumberOperator.Add, 3));
            AddModifier(new FloatModifier(VanillaDifficultyProps.REVERSE_SATELLITE_DAMAGE_MULTIPLIER, NumberOperator.AddMultiple, 2f));
            AddModifier(new IntModifier(VanillaDifficultyProps.SKELETON_HORSE_JUMP_TIMES, NumberOperator.Add, 3));
            ...
            AddModifier(new IntModifier(VanillaDifficultyProps.SLENDERMAN_MAX_FATE_TIMES, NumberOperator.Add, 5));

            AddModifier(new FloatModifier(VanillaDifficultyProps.CRUSHING_WALLS_SPEED, NumberOperator.Add, 1f));
            AddModifier(new FloatModifier(VanillaDifficultyProps.NIGHTMAREAPER_SPIN_DAMAGE, NumberOperator.Add, 15));
        ...
        public class EnemyAura : AuraEffectDefinition
        {
            ...
            {
                BuffID = VanillaBuffID.hellEnemy;
                UpdateInterval = 30;
            }
