...
{
    [BuffDefinition(VanillaBuffNames.Level.reverseSatelliteRage)]
    public class ReverseSatelliteBuffRage : BuffDefinition
    {
        public ReverseSatelliteBuffRage(string nsp, string name) : base(nsp, name)
        {
        ...
        public override void PostUpdate(Buff buff)
        {
            ...
            if (buff.Level.EntityExists(EntityTypes.BOSS))
            {
                timeout = MAX_TIMEOUT;
            }
            else
