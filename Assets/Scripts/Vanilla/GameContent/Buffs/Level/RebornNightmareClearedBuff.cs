...
{
    [BuffDefinition(VanillaBuffNames.Level.rebornnightmareCleared)]
    public class RebornNightmareClearedBuff : BuffDefinition
    {
        public RebornNightmareClearedBuff(string nsp, string name) : base(nsp, name)
        {
